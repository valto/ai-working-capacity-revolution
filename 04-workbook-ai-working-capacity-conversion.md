...
| Production tier | Low (best-case) $/M tok | Mid $/M tok | High (worst-case) $/M tok | Opex included? | Confidence class (per Asset #7) |
|---|---|---|---|---|---|
| **Home** — 1× DGX Spark, owned production | $1.71 | $3.17 | $11.89 | Yes (illustrative allowance) | High on hardware price/power (OBSERVED); throughput is an OBSERVED community benchmark; utilization is ASSUMPTION |
| **Cooperative** — 10× DGX Spark, 50 members, owned production | $1.99 | $3.20 | $7.62 | Yes (ASSUMPTION admin/networking band) | High on hardware; admin/overhead line is ASSUMPTION |
| **Professional** — 1× HGX B300 (8-GPU) node, owned production | $0.044 | $0.064 | $0.146 | **No — capital+financing+electricity only; see Asset #7 §4.3's illustrative opex sensitivity, mid-case rises to ~$0.080/M with opex added** | Low-medium — capex and power are ASSUMPTION placeholders (no public price/power found for this SKU); throughput is a DERIVED scaling estimate, not a direct benchmark |
| **Hyperscale/Industrial** — 1× GB300 NVL72 rack, owned production | $0.091 | $0.133 | $0.312 | Yes (ASSUMPTION opex band, $200k-1M/yr) | Medium — rack specs/power OBSERVED; capex is analyst-anchored ASSUMPTION, not an official NVIDIA price |
| **Retail API** — buy-from-market, NOT owned production (comparison layer only) | $0.90 | $9.00 | $38.00 | n/a (retail price, not a production-cost breakdown) | OBSERVED (Anthropic, Google) / ATTRIBUTED (OpenAI, via AI-summarizing fetch tool — see Asset #7 §7 confidence notes) |

**Corrected 2026-08-13:** the Professional tier's figures above exclude opex while Home, Cooperative, and Hyperscale include it — this is not a like-for-like comparison. Do not read Professional as simply "the cheapest owned-production tier"; part of its apparent advantage over Hyperscale is a cost-scope artifact, not a pure hardware-generation effect. See Asset #7 §4.3/§9 for the full correction.
