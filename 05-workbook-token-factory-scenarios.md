...
|---|---|---|---|---|---|
| Home factory (1× DGX Spark) | $4,699 **[FACT — current NVIDIA price, cluster A]** | ~$1,177/yr | ~$25–$202/yr (240W, $0.12/kWh ASSUMPTION, 10–80% utilization) | **$1.37–$11.89/M tokens** (10–80% utilization) — canonical figure, Global Baseline Workbook §2.4 | CALC (referenced) |
| Cooperative factory (10× DGX Spark, 50 members) | ~$46,990 | ~$11,294.76/yr | ~$505–$2,144/yr + admin | **$1.99–$7.62/M tokens** (20–85% utilization) — canonical figure, Global Baseline Workbook §3.4 | CALC (referenced) |
...
**Reading this table correctly:** owned-production costs above range from the Hyperscale tier's $0.091–$0.312/M (one to two orders of magnitude below these retail prices) up to the Home tier's $1.37–$11.89/M (closer to, and at low utilization inside, the cheapest retail floor). The gap is real and large at Hyperscale scale but narrower and utilization-dependent at Home/Cooperative scale — it is not evidence that retail labs are irrationally priced, since retail prices bundle proprietary model R&D, safety work, margin, and reliability guarantees that a self-hosted open-weight stack does not include; it is evidence that the size of the "generate your own power vs. buy from the grid" gap (Section 2) itself depends heavily on scale and utilization, not just on the choice to self-host.
...
**Why the AI-token numbers look so much larger:** they assume every token produced is sold at a *retail* frontier-model price (Section 4.2), which is the "buy from the grid" price, not a cost. **Corrected 2026-08-13:** an earlier version of this passage valued the same 750M tokens at a since-superseded, lower Home-tier cost figure (~$0.6–2/M) and additionally contained a 1,000x unit error, understating the resulting revenue-per-MWh by roughly a thousandfold (it stated $0.45–$1.50/MWh; the correct arithmetic even on that old, lower cost figure would have been $450–$1,500/MWh). Using this paper's canonical Home-tier figure ($1.37–$11.89/M tokens, Section 4), the same 750M tokens valued at owned-production cost are worth **$1,028–$8,918 per MWh-equivalent** — *above* even the efficient Bitcoin fleet, not below it. Only at the canonical Hyperscale tier's $0.091–$0.312/M does production-cost value fall to **$68–$234 per MWh-equivalent**, which brackets the efficient-fleet Bitcoin range (~$95+/MWh) rather than falling clearly below it. **The entire comparison is sensitive to which price point and which production tier you plug in, which is exactly why this is a scenario table with editable inputs, not a profitability claim about either activity, and it must not be read as one.**
