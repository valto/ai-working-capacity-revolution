...
| "$0.123/M tokens" TCO for GB300 NVL72 (DeepSeek-R1) | UNVERIFIABLE | Benchmark/API Query | inferencex.semianalysis.com, compare-per-dollar page + API | 2026-08-12 | Global | $/M tokens | Not found verbatim; nearby confirmed points range $0.065–$3.3/M tokens depending on interactivity (tok/s/user) setting; closest point (~117 tok/s/user) is $0.1075–$0.1298/M, not an exact match. |
...
|---|---|---|---|
| A — NVIDIA hardware/TCO | Direct Fetch (Live); Benchmark/API Query | GB300 core specs (NVIDIA's own page) | "$0.123/M tokens" and "2.8M tok/s/MW" (UNVERIFIABLE) |
