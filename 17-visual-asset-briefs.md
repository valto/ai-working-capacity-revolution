...
- The 6-model strip: six equal-width columns, explicitly captioned "coexisting access patterns — none universally superior, Section 27/30," each showing: cost range (with the flagged cooperative-cost discrepancy — €19.50–23 vs €42/member/month, Section 27/32 — shown as an open, unresolved range with both figures visible, not averaged or silently resolved), control/portability/exit/governance/continuity icons from Section 29's 5-question framework.
...
- The Cooperative panel must show the unresolved €19.50–23 vs €42/member/month range explicitly, not averaged, with a short note: "discrepancy deliberately left open — Section 27/32."
